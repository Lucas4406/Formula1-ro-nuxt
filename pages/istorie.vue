...
useHead({
  title: "Istorie Formula 1",
  meta: [
    {
      name: "description",
      content:
          "Aflați tot ce trebuie să știți despre istoria captivantă a Formulei 1, de la înființarea campionatului în 1950 până la momentele legendare din anii recenți.",
    },
    {
      name: "keywords",
      content:
          "Formula 1, istoria Formulei 1, Juan Manuel Fangio, Michael Schumacher, Campionatul Mondial de Formula 1, istorie curse auto",
    },
  ]
})
